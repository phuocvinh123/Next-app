...
export const Footer = () => {
  return (
    <>
      <div className='bg-[#7854F7] w-[1920px] h-[741px]'>
        <div className='flex flex-col items-center  text-white'>
          <div className='flex gap-[118px] flex-wrap pt-[51px] '>
          ...
          <div className='w-[1480px] h-[1px] bg-[#9A7DFF] mt-14'></div>
          <div className='flex justify-center gap-[138px] flex-wrap mt-9'>
            <div>
      ...
      <div className='bg-[#FFF] max-w-[1920px] h-[68px]'>
        <div className='flex flex-wrap justify-between items-center gap-5 py-[25px] px-[220px]'>
