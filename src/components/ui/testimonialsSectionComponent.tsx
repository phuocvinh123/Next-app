...
export const TestimonialSection = () => {
  ...
  return (
    <div className='bg-testimonial-background w-[1920px] h-[1009px] '>
      <div className='container mx-auto mt-6 flex flex-col'>
        <div className='text-center text-[55px] font-bold leading-[70px]'>
          Trusted by Agencies
          <br /> & Store Owners
        </div>
        <div className='flex items-center justify-center min-h-[calc(70vh-20px)] relative'>
          ...
          <div className='absolute w-[678px] h-[363px] rounded-[20px] bg-[#FFF] bottom-20 z-10'></div>
          <div className='absolute w-[618px] h-[313px] rounded-[20px] bg-[#FFF] bottom-14 z-[9]'></div>
          <div className='absolute w-[450px] flex flex-wrap gap-10 top-36 right-72 z-0'>
            {svgs.map((_, index) => (
              <svg
                key={index}
                xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='absolute w-[450px] flex flex-wrap gap-10 bottom-0 left-72 z-0'>
            {svgs.map((_, index) => (
              <svg
                key={index}
                xmlns='http://www.w3.org/2000/svg'
