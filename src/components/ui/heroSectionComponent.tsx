...
export const HeroSection = () => {
  ...
  return (
    <div className='lg:block flex flex-wrap'>
      <div className='relative container mx-auto mt-32'>
        <div className="2xl:w-[818px] w-[618px] text-[#272d4e] 2xl:text-[85px] text-[55px] font-semibold font-['Circular Std'] leading-[95px]">
          Building exactly the eCommerce website you want.
        </div>
        <div className='2xl:text-[18px] text-xs text-[#94A2B3] font-light mt-3'>
