...
const AdminHome = () => {
  ...
  return (
    <div className='flex'>
      <div className='w-[350px] h-[920px] bg-[#64748b] pl-4 fixed'>
        ...
        <div className='mt-5 flex flex-col gap-y-10 text-2xl ml-6 text-white font-normal'>
          ...
          <div className='border-b-[0.5px] border-[#rgb(131_131_131)] pb-4 w-[260px] cursor-pointer hover:text-red-300'>
            Dashboard
          </div>
        </div>
      </div>
      <div className='bg-gray-300 w-full h-[920px]'>
        <div className='w-[1520px] ml-[350px] h-[80px] bg-white p-5 flex justify-between fixed'>
          <div className='flex items-center gap-4 ml-4'>
            ...
            <div>
              <input
                type='search'
                className='border border-white hover:border-white focus:border-white focus:outline-none p-2'
